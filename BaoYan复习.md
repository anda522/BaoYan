...
>
> 中断:也称为异步中断。因此它是由其他硬件设备依照CPU时钟信号随机产生，即意味着中断能在指令之间发生。
>
> - 中断主要是响应外部硬件设备的。
> - 产生通过中断控制器，中断号是由中断控制器提供的（NMI硬中断中断号系统指定为02H）。
